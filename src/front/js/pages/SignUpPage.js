...
// 							<button className="btn btn-outline-light m-2" type="button" id="weightbtn">Lose Weight</button>
// 							<button className="btn btn-outline-light m-2" type="button" id="weightbtn">Gain Weight</button>
// 							<button className="btn btn-outline-light m-2" type="button" id="weightbtn">Maintain Weight</button>
// 						</div>
// 						<hr />
...
// 							<button className="btn btn-outline-light m-2" type="button" id="genderbtn">Male</button>
// 							<button className="btn btn-outline-light m-2" type="button" id="genderbtn">Female</button>
// 							<button className="btn btn-outline-light m-2" type="button" id="genderbtn">Other</button>
// 						</div>
// 					</div>
// 					<hr />
